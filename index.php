...
<div class="container border rounded mt-5 pt-3 ps-3 pb-3 pe-3 bg-white">
    <a class="btn btn-primary" href="views/cadastro.php">Cadastrar</a>
...
<table class="table table-bordered table-striped table-hover">
    ...
    <?php
    $query = mysqli_query($conexao, "SELECT * FROM alunos WHERE nome LIKE '%$varBuscar%' ORDER BY código DESC");
    while ($exibe = mysqli_fetch_array($query)) {
        ...
        <tr>
            ...
            <td><a class="btn btn-success"  href="views/cadastroAtualiza.php">Editar</a></td>
